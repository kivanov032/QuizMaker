...
- создание и хранение викторин;
- анализ викторины на ошибки;
- автоматическое исправление ошибок викторины;
- поиск созданных викторин из бд;
...
- общение с фронтом (React) за счёт http запросов
- отправка сообщений серверу User через Кафку
...
| POST  | `/search-quiz-errors`      | Поиск ошибок в викторине                              |
| POST  | `/fix-quiz-errors`         | Автоматическое исправление ошибок в викторине         |
| POST  | `/create-quiz`             | Создание новой викторины (занесение в бд)             |
| POST  | `/search-quiz`             | Поиск викторины по её названию                        |
| POST  | `/get-quiz-questions`      | Получение вопросов (данных) для прохождения викторины |
